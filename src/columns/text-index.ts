...
export default glide
  ...
  .withCategory("Text")
  .withDescription(`Gets the zero-based offset of the (one-based) N-th occurence of needle in haystack`)
  .withNumberResult()
  ...
  .withTest({ haystack: "there is one @ here", needle: "@", nth: 0 }, undefined)
  ...
  .withTest({ haystack: "there are two @ here in @ and there", needle: "@", nth: 0 }, undefined)
  .withTest({ haystack: "there are two @ here in @ and there", needle: "@", nth: 1 }, 14)
  .withTest({ haystack: "there are two @ here in @ and there", needle: "@", nth: 2 }, 24)
  .withTest({ haystack: "there are two @ here in @ and there", needle: "@", nth: 3 }, undefined)
  ...
  .withTest({ haystack: "@ but there's one in the front @ and middle", needle: "@", nth: 0 }, undefined)
  .withTest({ haystack: "@ but there's one in the front @ and middle", needle: "@", nth: 1 }, 0)
  .withTest({ haystack: "@ but there's one in the front @ and middle", needle: "@", nth: 2 }, 31)
  .withTest({ haystack: "@ but there's one in the front @ and middle", needle: "@", nth: 3 }, undefined)
  ...
  .withTest({ haystack: "@ and we want @ the second @", needle: "@", nth: 3 }, 27)
  ...
  .withTest({ haystack: "and == we can do == long == numbers ==", needle: "==", nth: 2 }, 17)
  .withTest({ haystack: "and == we can do == long == numbers ==", needle: "==", nth: 3 }, 25)
  .run(({ needle, haystack, nth }) => {
    let runs = nth ?? 1, foundIndex = -1;
