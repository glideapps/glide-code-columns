...
(function () {
    ...
    var AsyncGenerator_1 = createCommonjsModule(function (module) {
        ...
        AsyncGenerator.prototype[(typeof Symbol === "function" && Symbol.asyncIterator) || "@@asyncIterator"] =
            function () {
                return this;
            };
    ...
    (function (root, factory) {
        ...
        function isSymbol(x) {
            return (
                _typeof(x) === "symbol" ||
                (_typeof(x) === "object" && Object.prototype.toString.call(x) === "[object Symbol]")
            );
        } // ----------------------------------------------------------------------
        // :: LSymbol constructor
        // ----------------------------------------------------------------------
	  ...
	  */
        ...
        var Lexer = /*#__PURE__*/ (function () {
            function Lexer(input) {
                ...
                ["_i", "_whitespace", "_col", "_newline", "_line", "_state", "_next", "_token", "_prev_char"].forEach(
                    function (name) {
                                        ...
                                        while (1) {
                                            switch ((_context8.prev = _context8.next)) {
                                                ...
                                                case 19:
                                                    ...
                                                    return _context8.abrupt(
                                                        "return",
                                                        extension.apply(this.__env__, object.to_array(false))
                                                    );
                                                ...
                                                case 34:
                                                    throw new Error(
                                                        "Parse Error: invlid parser extension: " + special.symbol
                                                    );
                                                ...
                                                case 40:
                                                    throw new Error(
                                                        "Parse Error: invalid datum label #".concat(ref, "#")
                                                    );
	  ...
	  */
                ...
                for (var i = 0; i < input.length; ++i) {
                    ...
                    if (pattern[p] instanceof Pattern) {
                        ...
                        if (pattern[p] === Symbol["for"]("*")) {
                            ...
                            if (
                                (typeof pattern[p + 1] !== "undefined" && glob[p] === 0 && match_next() === -1) ||
                                glob[p] > 0
                            ) {
                                continue;
                            }
        ...
        function toString(obj, quote, skip_cycles) {
            ...
            if (obj) {
                ...
                if (instances.has(cls)) {
                    for (
                        var _len5 = arguments.length, pair_args = new Array(_len5 > 3 ? _len5 - 3 : 0), _key5 = 3;
                        _key5 < _len5;
                        _key5++
                    ) {
                                        ...
                                        case 0:
                                            _traverse = function _traverse3() {
                                                _traverse = _asyncToGenerator(
                                                    /*#__PURE__*/ regenerator.mark(function _callee11(node, n, env) {
                                                        var name,
                                                            value,
                                                            is_let,
                                                            is_binding,
                                                            ...
                                                            while (1) {
                                                                switch ((_context11.prev = _context11.next)) {
                                                                    ...
                                                                    case 28:
                                                                        ...
                                                                        code =
                                                                            value instanceof Syntax ? node : node.cdr;
                                                                        _context11.next = 32;
                                                                        return value.invoke(
                                                                            code,
                                                                            _objectSpread(
                                            ...
                                            _expand_let_binding = function _expand_let_binding3() {
                                                _expand_let_binding = _asyncToGenerator(
                                                    /*#__PURE__*/ regenerator.mark(function _callee10(node, n) {
                                                        var pair;
        ...
        function is_native_function(fn) {
            ...
            return (
                ...
                ((fn.name.match(/^bound /) && fn[_native] === true) || (!fn.name.match(/^bound /) && !fn[_native]))
            );
        } // ----------------------------------------------------------------------
        ...
        function fold(name, fold) {
            ...
            return function recur(fn, init) {
                ...
                for (
                    var _len10 = arguments.length, lists = new Array(_len10 > 2 ? _len10 - 2 : 0), _key10 = 2;
                    _key10 < _len10;
                    _key10++
                ) {
        ...
        function curry(fn) {
            for (
                var _len12 = arguments.length, init_args = new Array(_len12 > 1 ? _len12 - 1 : 0), _key12 = 1;
                _key12 < _len12;
                _key12++
            ) {
            ...
            return function () {
                ...
                function call() {
                    for (
                        var _len13 = arguments.length, more_args = new Array(_len13), _key13 = 0;
                        _key13 < _len13;
                        _key13++
                    ) {
        ...
        LNumber.isComplex = function (n) {
            ...
            var ret =
                ...
                ((LNumber.isNumber(n.im) || Number.isNaN(n.im)) && (LNumber.isNumber(n.re) || Number.isNaN(n.re)));
            return ret;
        }; // -------------------------------------------------------------------------
                            ...
                            while (1) {
                                switch ((_context14.prev = _context14.next)) {
                                    ...
                                    case 2:
                                        ...
                                        for (
                                            _len16 = _args16.length, args = new Array(_len16), _key16 = 0;
                                            _key16 < _len16;
                                            _key16++
                                        ) {
        ...
        function InputByteVectorPort(bytevectors) {
            if (
                (typeof this !== "undefined" && !(this instanceof InputByteVectorPort)) ||
        ...
        function OutputByteVectorPort() {
            if (
                (typeof this !== "undefined" && !(this instanceof OutputByteVectorPort)) ||
                typeof this === "undefined"
            ) {
        ...
        function InputBinaryFilePort(content, filename) {
            if (
                (typeof this !== "undefined" && !(this instanceof InputBinaryFilePort)) ||
                typeof this === "undefined"
            ) {
        ...
        function OutputBinaryFilePort(filename, fd) {
            if (
                (typeof this !== "undefined" && !(this instanceof OutputBinaryFilePort)) ||
                typeof this === "undefined"
            ) {
        ...
        var get = doc(
            ...
            function get(object) {
                for (
                    var _len17 = arguments.length, args = new Array(_len17 > 1 ? _len17 - 1 : 0), _key17 = 1;
                    _key17 < _len17;
                    _key17++
                ) {
        ...
        var global_env = new Environment(
            {
                ...
                format: doc(
                    ...
                    function format(str) {
                        for (
                            var _len19 = arguments.length, args = new Array(_len19 > 1 ? _len19 - 1 : 0), _key19 = 1;
                            _key19 < _len19;
                            _key19++
                        ) {
                    ...
                    new Macro(
                        ...
                        /*#__PURE__*/ (function () {
                            var _ref29 = _asyncToGenerator(
                                /*#__PURE__*/ regenerator.mark(function _callee17(code, _ref30) {
                                    var dynamic_scope,
                                        error,
                                        self,
                                        scope,
                    ...
                    Macro.defmacro("define", function (code, eval_args) {
                        ...
                        if (code.car instanceof Pair && code.car.car instanceof LSymbol) {
                            var new_code = new Pair(
                                ...
                                new Pair(
                                    code.car.car,
                                    new Pair(new Pair(new LSymbol("lambda"), new Pair(code.car.cdr, code.cdr)))
                                )
                            );
                            return new_code;
                ...
                quasiquote: Macro.defmacro(
                    ...
                    function (arg, env) {
                        ...
                        function unquote_splice(pair, unquote_cnt, max_unq) {
                            if (unquote_cnt < max_unq) {
                                return new Pair(
                                    new Pair(pair.car.car, recur(pair.car.cdr, unquote_cnt, max_unq)),
                                    _nil
                                );
                            }
                ...
                append: doc(
                    ...
                    function append() {
                        ...
                        for (
                            var _len23 = arguments.length, items = new Array(_len23), _key23 = 0;
                            _key23 < _len23;
                            _key23++
                        ) {
                ...
                "append!": doc(
                    ...
                    function () {
                        ...
                        for (
                            var _len24 = arguments.length, items = new Array(_len24), _key24 = 0;
                            _key24 < _len24;
                            _key24++
                        ) {
                ...
                new: doc(
                    ...
                    function (obj) {
                        for (
                            var _len27 = arguments.length, args = new Array(_len27 > 1 ? _len27 - 1 : 0), _key27 = 1;
                            _key27 < _len27;
                            _key27++
                        ) {
                ...
                "set-special!": doc(
                    ...
                    function (seq, name) {
                        var type =
                            arguments.length > 2 && arguments[2] !== undefined$1 ? arguments[2] : specials.LITERAL;
                ...
                apply: doc(
                    ...
                    function apply(fn) {
                        for (
                            var _len28 = arguments.length, args = new Array(_len28 > 1 ? _len28 - 1 : 0), _key28 = 1;
                            _key28 < _len28;
                            _key28++
                        ) {
                        ...
                        return new Promise(function (resolve, reject) {
                            ...
                            if (finally_clause) {
                                _next = function next(result, cont) {
                                    ...
                                    _next = reject;
                                    unpromise(
                                        _evaluate(new Pair(new LSymbol("begin"), finally_clause.cdr), args),
                                        function () {
                                            cont(result);
                                        }
                                    );
                            ...
                            var args = {
                                ...
                                error: function error(e) {
                                    ...
                                    if (catch_clause) {
                                        ...
                                        unpromise(
                                            _evaluate(new Pair(new LSymbol("begin"), catch_clause.cdr.cdr), args),
                                            function (result) {
                ...
                "for-each": doc(
                    ...
                    function (fn) {
                        ...
                        for (
                            var _len29 = arguments.length, lists = new Array(_len29 > 1 ? _len29 - 1 : 0), _key29 = 1;
                            _key29 < _len29;
                            _key29++
                        ) {
                ...
                map: doc(
                    ...
                    function map(fn) {
                        ...
                        for (
                            var _len30 = arguments.length, lists = new Array(_len30 > 1 ? _len30 - 1 : 0), _key30 = 1;
                            _key30 < _len30;
                            _key30++
                        ) {
                ...
                fold: doc(
                    ...
                    fold("fold", function (fold, fn, init) {
                        for (
                            var _len31 = arguments.length, lists = new Array(_len31 > 3 ? _len31 - 3 : 0), _key31 = 3;
                            _key31 < _len31;
                            _key31++
                        ) {
                ...
                pluck: doc(
                    ...
                    function pluck() {
                        for (
                            var _len32 = arguments.length, keys = new Array(_len32), _key32 = 0;
                            _key32 < _len32;
                            _key32++
                        ) {
                ...
                reduce: doc(
                    ...
                    fold("reduce", function (reduce, fn, init) {
                        ...
                        for (
                            var _len33 = arguments.length, lists = new Array(_len33 > 3 ? _len33 - 3 : 0), _key34 = 3;
                            _key34 < _len33;
                            _key34++
                        ) {
                ...
                gcd: doc(
                    ...
                    function gcd() {
                        for (
                            var _len34 = arguments.length, args = new Array(_len34), _key35 = 0;
                            _key35 < _len34;
                            _key35++
                        ) {
                ...
                lcm: doc(
                    ...
                    function lcm() {
                        for (
                            var _len35 = arguments.length, args = new Array(_len35), _key36 = 0;
                            _key36 < _len35;
                            _key36++
                        ) {
                ...
                "-": doc(
                    ...
                    function () {
                        for (
                            var _len36 = arguments.length, args = new Array(_len36), _key37 = 0;
                            _key37 < _len36;
                            _key37++
                        ) {
                ...
                "/": doc(
                    ...
                    function () {
                        for (
                            var _len37 = arguments.length, args = new Array(_len37), _key38 = 0;
                            _key38 < _len37;
                            _key38++
                        ) {
                ...
                "==": doc(
                    ...
                    function () {
                        for (
                            var _len38 = arguments.length, args = new Array(_len38), _key39 = 0;
                            _key39 < _len38;
                            _key39++
                        ) {
                ...
                ">": doc(
                    ...
                    function () {
                        for (
                            var _len39 = arguments.length, args = new Array(_len39), _key40 = 0;
                            _key40 < _len39;
                            _key40++
                        ) {
                ...
                "<": doc(
                    ...
                    function () {
                        for (
                            var _len40 = arguments.length, args = new Array(_len40), _key41 = 0;
                            _key41 < _len40;
                            _key41++
                        ) {
                ...
                "<=": doc(
                    ...
                    function () {
                        for (
                            var _len41 = arguments.length, args = new Array(_len41), _key42 = 0;
                            _key42 < _len41;
                            _key42++
                        ) {
                ...
                ">=": doc(
                    ...
                    function () {
                        for (
                            var _len42 = arguments.length, args = new Array(_len42), _key43 = 0;
                            _key43 < _len42;
                            _key43++
                        ) {
                ...
                var _loop4 = function _loop4() {
                    ...
                    if (is_lips_function(arg)) {
                        wrapper = function wrapper() {
                            for (
                                var _len43 = arguments.length, args = new Array(_len43), _key45 = 0;
                                _key45 < _len43;
                                _key45++
                            ) {
        ...
        function _exec() {
            _exec = _asyncToGenerator(
                /*#__PURE__*/ regenerator.mark(function _callee20(arg, env, dynamic_scope) {
                    var results,
                        input,
